...
<%@page import="in.co.online.sport.controller.CategoryListCtl"%>
...
<div class="bg-light py-3">
    ...
    <div class="site-section">
      ...
      <div class="container">
      <form class="col-md-12" action="<%=OSSView.CATEGORY_LIST_CTL%>" method="post">
        <div class="row mb-5">
				...
				%>
                  <tr>
                    <td class="product-thumbnail">
                      <img height="250px" width="250px" src="<%=OSSView.APP_CONTEXT%>/images/<%=bean.getImage()%>" alt="Image" class="img-fluid">
                    </td>
