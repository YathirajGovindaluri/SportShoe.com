...
import in.co.online.sport.exception.RecordNotFoundException;
import in.co.online.sport.util.EmailBuilder;
import in.co.online.sport.util.EmailMessage;
import in.co.online.sport.util.EmailUtility;
...
public class UserModel {
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE s_USER SET FIRSTNAME=?,LASTNAME=?,LOGIN=?,PASSWORD=?,DOB=?,MOBILENO=?,ROLEID=?,gender=?,"
	...
	public List getRoles(UserBean bean) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM s_USER WHERE roleId=?");
		Connection conn = null;
