package in.co.online.sport.util;
...
import in.co.online.sport.controller.BaseCtl;
import in.co.online.sport.controller.OSSView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(OSSView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
